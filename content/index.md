...
**3 main points:**
1. **west marches[^2] (or close)**
   it features a large player pool, a safe home base, and zero fixed schedules or preset plots. players decide where to explore, and the game master builds the world reactively based on those choices.
2. **player choice**
